...
JointStateToTwist(const std::string& prefix, const std::string& use_stamped,
    ...
    {           
        ...
        // if (use_stamped_ == "True") {
        cmd_vel_pub_0_stamped_ = this->create_publisher<geometry_msgs::msg::TwistStamped>(full_topic_name_0_, default_qos);
        cmd_vel_pub_1_stamped_ = this->create_publisher<geometry_msgs::msg::TwistStamped>(full_topic_name_1_, default_qos);
        cmd_vel_pub_2_stamped_ = this->create_publisher<geometry_msgs::msg::TwistStamped>(full_topic_name_2_, default_qos);
        cmd_vel_pub_3_stamped_ = this->create_publisher<geometry_msgs::msg::TwistStamped>(full_topic_name_3_, default_qos);
        // } else {
        //     cmd_vel_pub_0_ = this->create_publisher<geometry_msgs::msg::Twist>(full_topic_name_0_, default_qos);
        //     cmd_vel_pub_1_ = this->create_publisher<geometry_msgs::msg::Twist>(full_topic_name_1_, default_qos);
        //     cmd_vel_pub_2_ = this->create_publisher<geometry_msgs::msg::Twist>(full_topic_name_2_, default_qos);
        //     cmd_vel_pub_3_ = this->create_publisher<geometry_msgs::msg::Twist>(full_topic_name_3_, default_qos);
        // }
...
private:
    ...
    void amr_cmds_callback(const sensor_msgs::msg::JointState::SharedPtr msg_cmd) {
        ...
        double angular_velocity = 1.2 ;  // 0.8

        // if (use_stamped_ == "True") {
        geometry_msgs::msg::TwistStamped twist_msg_stamped_0;
        geometry_msgs::msg::TwistStamped twist_msg_stamped_1;
        geometry_msgs::msg::TwistStamped twist_msg_stamped_2;
        ...
        twist_msg_stamped_1.twist.linear.x = linear_velocity[1];
        twist_msg_stamped_1.twist.angular.z = angular_velocity * error_position[1] / wheel_drive_len_;

        twist_msg_stamped_2.twist.linear.x = linear_velocity[2];
        twist_msg_stamped_2.twist.angular.z = angular_velocity * error_position[2] / wheel_drive_len_;
        ...
        twist_msg_stamped_1.header.stamp = this->get_clock()->now();
        twist_msg_stamped_2.header.stamp = this->get_clock()->now();
        twist_msg_stamped_3.header.stamp = this->get_clock()->now();

        cmd_vel_pub_0_stamped_->publish(twist_msg_stamped_0);
        cmd_vel_pub_1_stamped_->publish(twist_msg_stamped_1);
        cmd_vel_pub_2_stamped_->publish(twist_msg_stamped_2);
        cmd_vel_pub_3_stamped_->publish(twist_msg_stamped_3);
        // } else {
        //     geometry_msgs::msg::Twist twist_msg_0;
        //     geometry_msgs::msg::Twist twist_msg_1;
        //     geometry_msgs::msg::Twist twist_msg_2;
        //     geometry_msgs::msg::Twist twist_msg_3;

        //     twist_msg_0.linear.x = linear_velocity[0];
        //     twist_msg_0.angular.z = angular_velocity * error_position[0] / wheel_drive_len_;

        //     twist_msg_1.linear.x = linear_velocity[1];
        //     twist_msg_1.angular.z = angular_velocity * error_position[1] / wheel_drive_len_;

        //     twist_msg_2.linear.x = linear_velocity[2];
        //     twist_msg_2.angular.z = angular_velocity * error_position[2] / wheel_drive_len_;

        //     twist_msg_3.linear.x = linear_velocity[3];
        //     twist_msg_3.angular.z = angular_velocity * error_position[3] / wheel_drive_len_;
    ...
    rclcpp::Publisher<geometry_msgs::msg::TwistStamped>::SharedPtr cmd_vel_pub_1_stamped_;
    rclcpp::Publisher<geometry_msgs::msg::TwistStamped>::SharedPtr cmd_vel_pub_2_stamped_;
    rclcpp::Publisher<geometry_msgs::msg::TwistStamped>::SharedPtr cmd_vel_pub_3_stamped_;
    // rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr cmd_vel_pub_0_;
    ...
    // rclcpp::Publisher<geometry_msgs::msg::Twist>::SharedPtr cmd_vel_pub_3_;
};
