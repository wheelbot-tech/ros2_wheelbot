...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("description"), "urdf/robots", "ackermann_2BOT.urdf.xacro"]
            ),
        ]
    )
    ...
    robot_controllers = PathJoinSubstitution([FindPackageShare("bringup"), "config", "ackermann_2BOT_controllers.yaml"])
    ...
    convertor_node = Node(
        package="bringup",
        executable="jointstate_to_twist_2_ackermann",
        name="jointstate_to_twist",
        output="screen",
        parameters=[{
    ...
    jointstate_aggregator_node = Node(
        package='bringup',
        executable='jointstate_aggregator_2_ackermann',
        name='jointstate_aggregator',
        output="screen",
    )
