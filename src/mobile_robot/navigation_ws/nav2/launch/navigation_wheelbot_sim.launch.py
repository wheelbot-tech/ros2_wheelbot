...
def generate_launch_description():
    ...
    map_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            ...
            'maps',
            'cylinder_garden2_map.yaml'))


    
    param_file_name = 'navigation_sim.yaml'
    ...
    nav2_launch_file_dir = os.path.join(get_package_share_directory('nav2'), 'launch')
    ...
    start_navigation = GroupAction([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([nav2_launch_file_dir, '/navigation.launch.py']),
