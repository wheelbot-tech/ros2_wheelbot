...
def generate_launch_description():
    ...
    isaac_custom_launch_script = os.path.join(pkg_wheelbot_isaac_path, "tools", "isaac_launch_script_2.py")
    ...
    world_name = DeclareLaunchArgument(
        'world_name',
        default_value='cylinder_garden.usda',
