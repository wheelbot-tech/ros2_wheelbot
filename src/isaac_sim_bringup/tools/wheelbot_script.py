...
WHEELBOT_STAGE_PATH = "/World/wheelbot"
...
add_reference_to_stage(usd_path=args.robot_file, prim_path=WHEELBOT_STAGE_PATH)
simulation_app.update()
simulation_app.update()
...
try:
   og.Controller.edit(
        {"graph_path": "/World/ROS_Clock", "evaluator_name": "execution"},
        {
